param(
    [string]$OutputZip = "C:\Magisterka\FineTuning\polish_forms_qwen3vl_lora_colab.zip"
)
...
$stagingRoot = Join-Path $fineTuningRoot ".qwen_colab_staging"
...
foreach ($dir in @("images", "manifests", "qwen")) {
