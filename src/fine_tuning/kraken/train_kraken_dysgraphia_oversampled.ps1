param(
    ...
    [string]$OutputDir = "C:\Magisterka\FineTuning\Kraken\outputs\dysgraphia_oversampled",
    [string]$BaseModel = "",
    [int]$Epochs = 50,
    [int]$BatchSize = 4
)
...
$trainManifest = Join-Path $pageRoot "train_dysgraphia_oversampled\manifest.txt"
