...
The full TrOCR fine-tuned checkpoint is not included because its `model.safetensors` file is approximately 2.4 GB. This exceeds practical GitHub repository limits and should be stored externally, for example on Google Drive, institutional storage, or Hugging Face Hub.
